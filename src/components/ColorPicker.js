...
function ColorPicker({setTaskColor, toggleColorPicker}){
    ...
    const colors = [    "#2C3D4F", "#91A79E", "#F1E5C8", "#EDB19F", "#C87660",
                        "#D1AAA7", "#C6A7D1", "#A7D1C1", "#BCD1A7", "#615855",
                        "#555B61", "#5FC6C7", "#CEA296", "#B87A76", "#C75F7A",
    ...
    return (
        ...
        <div className="color-picker">
            {colors.map( item=>{return < div key={item} 
